...
const phases = [
  { title: "ترسية المشروع واستلام الموقع", text: "تم في هذه المرحلة ترسية المشروع بتاريخ 1443/06/10 واستلام الموقع من قبل المقاول بتاريخ 1443/08/10 لبدء العمل." },
  { title: "الرفع المساحي وتوريد الخامات", text: "تم في هذه المرحلة تجهيز الموقع ورفعه مساحياً وفقاً لإحداثيات الأمانة، كما تم توريد الخامات والمعدات إلى مقر العمل." },
  { title: "أعمال الحفر والتركيب", text: "تم في هذه المرحلة أعمال الحفر للخطوط الرئيسية والفرعية وتم تركيب المواسير وغرف التفتيش ومصائد تجميع المياه." },
  { title: "أعمال الردم والسفلتة", text: "تم في هذه المرحلة ردم وتسوية ورصف الشوارع والطرق بالمشروع وأعادتها لحالتها الطبيعية." },
...
const resourceItems = [
  ...
  { value: 106, unit: "معدة", label: "العنصر التشغيلي", detail: "معدات خفيفة وثقيلة ومعدات حفر وردم ودك تربة ومولدات كهربائية ومضخات سحب مياه وغيرها من المعدات والآليات." }
];

const equipmentItems = [
  { kicker: "العنصر البشري", title: "الكوادر الفنية المؤهلة", text: "انقسمت عناصر العمل بالمشروع إلى قسمين أولهما العنصر البشري المتمثل في الكوادر الفنية المؤهلة لأعمال التنفيذ والإشراف والمتابعة." },
  { kicker: "العنصر التشغيلي", title: "المعدات والأدوات المختلفة", text: "ثانيهما العنصر التشغيلي المتمثل في المعدات (خفيفة - ثقيلة) والأدوات المختلفة اللازمة لإنجاز الأعمال على الوجه الصحيح." },
...
const qualityItems = [
  { kicker: "المعايير الفنية والهندسية", title: "المعايير الفنية والهندسية", text: "هي المعايير الخاصة بتطبيق المواصفات الوطنية والدولية والأكواد والأدلة المرجعية في جميع مراحل تنفيذ المشروع." },
  { kicker: "معايير السلامة المهنية", title: "معايير السلامة المهنية", text: "هي المسؤولة عن ضمان سلامة وصحة ظروف العمل للعاملين وللمجتمع للحد من المخاطر والحفاظ على الأرواح والممتلكات." },
  { kicker: "معايير جودة الخامات", title: "معايير جودة الخامات", text: "هي المعايير الخاصة بجودة الخامات والمواد المستخدمة في مراحل المشروع المختلفة وشهادات الضمان الخاصة بها." },
  { kicker: "معايير الجودة البيئية", title: "معايير الجودة البيئية", text: "هي المعايير الخاصة بالحفاظ على الجوانب البيئية من ناحية المواد والمعدات المستخدمة وكذلك طرق التخلص من المخلفات الناتجة." },
  { kicker: "معايير مراقبة الجودة واختبارات التحقق", title: "معايير مراقبة الجودة واختبارات التحقق", text: "هي المعايير الخاصة بمراقبة تنفيذ المشروع في مراحله المختلفة واختبار الأعمال والمخططات لاعتمادها من استشاري الإشراف على التنفيذ." }
];
...
const environmentItems = [
  { kicker: "المخلفات والردميات", title: "التخلص السليم من المخلفات", text: "تم التخلص من مخلفات المشروع سواء كانت مخلفات ناتجة عن عمليات الحفر والكشط أو مخلفات المكاتب الإدارية في الأماكن المخصصة لذلك والمعتمدة لدى أمانة جدة." },
  { kicker: "العوادم والانبعاثات الحرارية", title: "الحد من العوادم والانبعاثات", text: "تم العمل في المشروع على الحد من العوادم والانبعاثات الحرارية الناتجة عن المعدات والآلات المستخدمة في عمليات التنفيذ المختلفة وذلك حفاظاً على البيئة وعلى الكادر البشري في المشروع." },
  { kicker: "المواد والخامات", title: "مواد وخامات صديقة للبيئة", text: "تم اختيار مواد وخامات صديقة للبيئة تحقق الكفاءة والجودة وكذلك غير مضرة بالبيئة سواء على المدى الزمني القصير أو البعيد." },
  { kicker: "الأتربة والضوضاء", title: "تقليل الأتربة والضوضاء", text: "تم العمل في المشروع على الحد من الاتربة والغبار الناتج أثناء عمليات الحفر والردم وكذلك الحد من الضوضاء أثناء التنفيذ واختيار أوقات وطرق تنفيذ تهدف إلى الحد والتقليل من ذلك." }
];
